...
// Auto-fit bounds component - must be inside MapContainer
function FitBoundsController({ markers }: { markers: LatLngExpression[] }) {
  const map = useMap();
  ...
  return (
    ...
    >
      ...
      >
        ...
        {mapReady && allPositions.length > 0 && <FitBoundsController markers={allPositions} />}
      ...
      <div className="absolute inset-0 bg-transparent group-hover:bg-black/20 transition-colors flex items-center justify-center pointer-events-none">
      ...
      {/* Stats overlay */}
      <div className="absolute bottom-2 right-2 bg-black/60 backdrop-blur-sm rounded-md px-2 py-1 text-xs text-white z-[1000]">
